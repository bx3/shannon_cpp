...
public:              
    Contig_graph_handler(kmer_len_t length,
         Kmer_handler * khp, Contig_handler * chp, char * shc): 
...
private:    
    ...
    std::vector<contig_num_t> component_array;
    contig_num_t curr_component_num;
