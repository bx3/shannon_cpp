...
char shc_logname[50] = "./log/default_shannonC_log";
...
void test_Contig_graph()
{
    ...
    std::string input_filename("./test_data/k1mer.dict_org");
    std::string output_contig_filename("./output/contig.txt");
...
void test_Kmer_without_filter()
{
    ...
    std::string input_filename("./test_data/k1mer.dict_org");
    std::string output_contig_filename("./output/contig_without_filter.txt");
